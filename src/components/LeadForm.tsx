          ...
          <div className="lg:col-span-5 flex flex-col justify-center">
            ...
            <div className="mt-8">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full border border-green-500/30 bg-green-500/10 px-5 py-2.5 text-xs font-semibold text-green-400 transition-all duration-300 hover:bg-green-500/20 hover:border-green-500/60 hover:shadow-[0_0_16px_-4px_rgba(34,197,94,0.4)]"
              >
